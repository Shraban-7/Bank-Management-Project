        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 ">
            <div class="bg-white overflow-hidden  sm:rounded-lg  shadow-default dark:border-strokedark dark:bg-boxdark">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="text-center">
                        <h2 class="text-xl font-regular mb-4">Fullname: <span>{{ Auth::user()->name }}</span></h2>
                    </div>

                    <div class="text-center">
                        <p class="text-md font-regular">Email : {{ Auth::user()->email }}</p>
                    </div>

                    <div class="text-center">
                        <p class="text-md font-regular">Contact Number : {{ Auth::user()->ph_no }}</p>
                    </div>
    ...
    <div class="pt-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 ">
            <div class="bg-white overflow-hidden shadow-default ">
                <div class="p-6 text-gray-900">
                    <form action="{{ route('profile') }}" method="get" class="grid grid-cols-3 gap-3"
                        ...
                        <div class="relative z-20 bg-transparent dark:bg-form-input">
                            <select name="category_id"
                                class="relative z-20 w-full appearance-none rounded border border-stroke bg-transparent py-3 px-5 outline-none transition focus:border-blue-500 focus:ring focus:ring-blue-200 ">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 ">
            <div
                ...
                <div class="max-w-full overflow-x-auto">
                    <div class="text-center">
                        <h2 class="text-2xl font-semibold mb-4 ">Your FIle Uploads Info</h2>
                    </div>
                            ...
                            @foreach ($documents as $document)
                                <tr>
                                    ...
                                    <td class="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                                        <p class="text-black dark:text-white">{{ $document->docs_title }}-
                                            {{ $document->user_id }}</p>
                                    </td>
                                    <td class="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
