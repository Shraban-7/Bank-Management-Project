        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 ">
            <div class="bg-white overflow-hidden  sm:rounded-lg  shadow-default dark:border-strokedark dark:bg-boxdark">
                <div class="p-6 text-gray-900">
                    ...
                    @endif
                    <h2 class="text-2xl font-semibold mb-4">Add Permission</h2>
                    <form action="{{ route('permission.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-4">
                            <label for="name"
                                class="mb-3 text-gray-700 block font-medium  text-black dark:text-white">Permission
                                Name</label>
                                    ...
                                    <td class="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                                     ...
                                     <td class="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                                        <div class="flex items-center space-x-3.5">
                                            <a href="{{ route('permission.edit', $permission->id) }}" class="hover:text-primary">
                                            ...
                                            <a href="{{ route('permission.delete', $permission->id) }}" class="hover:text-primary">
                                                <svg class="fill-current" width="18" height="18" viewBox="0 0 18 18"
                                                    fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path
