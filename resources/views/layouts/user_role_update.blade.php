                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('user.update',$user->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="name" readonly value="{{ $user->name }}" name="name"
                        ...
                        <div class="mb-4">
                            ...
                            <input type="email" id="name" readonly value="{{ $user->email }}" name="email"
                                class="w-full px-4 py-2  border-stroke bg-transparent  font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter rounded border border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200 dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary"
                                required>
                        </div>
                        <div class="mb-4">
                            ...
                            <input type="text" id="name" readonly value="{{ $user->ph_no }}" name="ph_no"
                                class="w-full px-4 py-2  border-stroke bg-transparent  font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter rounded border border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200 dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary"
                                required>
                        </div>
                        <div class="mb-4.5">
                            ...
                            <div class="relative z-20 bg-transparent dark:bg-form-input">
                              <select
                                ...
                                <option @if ($user->dept_id==$department->id)
                                        selected
                            ...
                            <div class="relative z-20 bg-transparent dark:bg-form-input">
                                <select
                                    ...
                                    @foreach ($roles as $role)
                                        <option @if ($user->hasRole($role->name)==$role->name)
                                            selected
